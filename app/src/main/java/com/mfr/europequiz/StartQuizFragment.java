...
import com.mfr.europequiz.databinding.FragmentStartQuizBinding;
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.startQuiz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(StartQuizFragment.this)
                        .navigate(R.id.action_StartQuizFragment_to_QuizFragment);
            }
        });
    }
